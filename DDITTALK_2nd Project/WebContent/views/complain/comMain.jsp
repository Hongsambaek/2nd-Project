...
<h2 id="comHead">내 문의내역</h2>
<div id="comHead">최근 6개월 동안 접수하신 1:1문의내역 및 답변 내용을 확인하실 수 있습니다.</div><br>
<span id="comHead">※ 문의 내용 중 개인정보가 포함되었거나 중복된 문의인 경우 삭제될 수 있습니다.</span>
...
<table>
    ...
    %>
    <tr>
        <td colspan="4">문의내용이 존재하지 않습니다.</td>
    </tr>
    <%
        }
    %>
...
<div class="buttons">
    <button type="button" id="comDetail" onclick="window.location.href='<%=request.getContextPath()%>/cominsert.do'">문의하기</button>
</div>
